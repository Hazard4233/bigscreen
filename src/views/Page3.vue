  ...
  <div class=" bg-r1g8b14 flex flex-col w-full" style="height:56.25vw;padding-top:0.521vw">
    <div class="page3_header w-full flex flex-col relative">
      ...
      <div class="font-bold text-r93g192b191 absolute left-1/2 transform -translate-x-1/2" 
        style="font-size:2.04375vw;text-shadow:0px 0px 4px rgb(46 154 245);top:2.4354166vw;">DATA SCREEN</div>
    ...
    <div class="w-full flex flex-row mt-auto" style="height: 50.46875vw;padding-left:1.5vw;padding-right:1.5vw;padding-bottom:1.458333vw;">
      <div class="h-full flex flex-col">
        <div class="page3_part1 relative">
          <div class="w-full h-full">
            <img class="w-full absolute top-0 left-0" src="../assets/img/page3_part1_bg.png" alt="">
            ...
            <transition name="fade">
              <div v-if="enable_map_dlg"
                  ...
                  style="box-shadow: rgba(14, 40, 51, 1) 0px 2px 4px 0px, rgba(14, 40, 51, 1) 0px 2px 16px 0px;height:24.6vw;">
        ...
        <div class="flex flex-row items-center mt-auto">
          <div class="page3_part2 mr-auto flex flex-col">
            <div class="text-r114g149b164 font-bold text-center" style="font-size:1.5625vw;margin-top:1.0416vw">Real-time Alarm</div>
            <div class="alert_tb w-full mt-2 overflow-hidden">
              <table class="w-full">
                <thead class="sticky top-0 left-0 bg-r1g8b14">
                  <tr style="height: 1.4583333vw">
                    <td class="text-center text-r114g149b164" style="font-size:0.729166vw;">Name</td>
                    <td class="text-center text-r114g149b164" style="font-size:0.729166vw;">Reason</td>
                    <td class="text-center text-r114g149b164" style="font-size:0.729166vw;">Time</td>
                  </tr>
                </thead>
                <tbody>
                  <tr 
          ...
          <div class="page3_part2 ml-auto flex flex-col relative">
            <div class="text-r114g149b164 font-bold text-center" style="font-size:1.5625vw;margin-top:1.0416vw">Alarm Summary</div>
            <div id="bar_chart"></div>
            <div class=" absolute flex flex-col" style="top: 20%;right: 5%;">
              <div class="flex flex-row items-center">
                <div class="text-r114g149b164">Lat:</div>
                <div class=" text-r114g149b164 ml-2">55.23452</div>
              </div>
              <div class="flex flex-row items-center">
                <div class="text-r114g149b164">Lon:</div>
                <div class="text-r114g149b164 ml-2">-2.33542</div>
              </div>
            </div>
            <div class=" absolute flex flex-col" style="bottom: 5%;right:5%;">
              <div v-for="(item, index) in bar_chart_data_type" :key="item + index">
                <div class="flex flex-row items-center">
                  ...
                  <div class="ml-3 text-r114g149b164 text-sm">{{item.title}}</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="ml-auto h-full flex flex-col">
        <div class="page3_part4 ml-auto flex flex-col">
          <div class="text-r114g149b164 font-bold text-center" style="font-size:1.5625vw;margin-top:1.0416vw">Statistics</div>
          <div id="total_pie_chart"></div>
        </div>
        <div class="my-auto">
          <div class="page3_part5 relative">
            <div class="text-r114g149b164 font-bold text-center" style="font-size:1.5625vw;">Order Statistics</div>
            <div class="work_order_tb relative w-full overflow-hidden" style="margin-top:1.87661vw;">
              <table class="w-full">
                <thead class="sticky top-0 left-0 bg-r1g8b14">
                  <tr style="height: 1.4583333vw">
                    <td class="text-center text-r114g149b164" style="font-size:0.729166vw;">Type</td>
                    <td class="text-center text-r114g149b164" style="font-size:0.729166vw;">Name</td>
                    <td class="text-center text-r114g149b164" style="font-size:0.729166vw;">Service Type</td>
                    <td class="text-center text-r114g149b164" style="font-size:0.729166vw;">Status</td>
                    <td class="text-center text-r114g149b164" style="font-size:0.729166vw;">Time</td>
                  </tr>
                </thead>
                <tbody>
...
export default {
  ...
  methods: {
    ...
    showAllWorkOrder() {
      ...
      document.querySelector(".work_order_tb").style.height = '11.875vw'
    ...
    closeAllWorkOrder() {
      ...
      document.querySelector(".work_order_tb").style.height = '4.010416vw'

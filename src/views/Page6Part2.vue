    ...
    <div class="absolute top-10 flex flex-row items-center" style="left:29.65284vw;top:4.9662487vw;">
        <router-link to="/page6/part1">
            <div class="flex flex-row items-center cursor-pointer">
                ...
                <div class="text-r205g234b255 px-2 ml-1 flex flex-row items-center justify-center" 
                    style="height: 1.63934vw; background-image: linear-gradient(to bottom, rgb(0, 0, 0), rgb(25, 71, 107)); font-size: 0.867888vw;">Real-Time Alarm</div>
            </div>
        </router-link>
        <router-link to="/page6/part2">
            <div class="flex flex-row items-center cursor-pointer" style="margin-left:2.89296vw;">
                ...
                <div class="text-r205g234b255 px-2 ml-1 flex flex-row items-center justify-center" 
                    style="height: 1.63934vw; background-image: linear-gradient(to bottom, rgb(0, 0, 0), rgb(187, 124, 31)); font-size: 0.867888vw;">Historical Alarm</div>
            </div>
        </router-link>
    </div>
        ...
        <div class="flex flex-col">
            <div class="page6_part2_part1">
                <div class="flex flex-row items-center" style="margin-top:1.54291vw;margin-left:1.54291vw;">
                    ...
                    <div class="text-r205g234b255 px-2 ml-1 flex flex-row items-center justify-center"
                        style="height:1.6393442vw; background-image: linear-gradient(to top right, #19476b, #030a19);font-size:0.8678881vw;">Alarm Statistics</div>
                </div>
            ...
            <div class="page6_part2_part2 mt-auto">
                <div class="flex flex-row items-center" style="margin-top:1.54291vw;margin-left:1.54291vw;">
                    <div class="bg-r205g234b255" style="width:0.15625vw;height: 1.6393442vw;"></div>
                    <div class="text-r205g234b255 px-2 ml-1 flex flex-row items-center justify-center"
                        style="height:1.6393442vw; background-image: linear-gradient(to top right, #19476b, #030a19);font-size:0.8678881vw;">Alarm Trend</div>
                </div>
        ...
        <div class="flex flex-col ml-auto">
            <div class="page6_part2_part_3">
                <div class="flex flex-row items-center" style="margin-top:1.54291vw;margin-left:1.54291vw;">
                    <div class="bg-r205g234b255" style="width:0.15625vw;height: 1.6393442vw;"></div>
                    <div class="text-r205g234b255 px-2 ml-1 flex flex-row items-center justify-center"
                        style="height:1.6393442vw; background-image: linear-gradient(to top right, #19476b, #030a19);font-size:0.8678881vw;">Historical Alarm List</div>
                </div>
                <div class="flex flex-row items-center" style="margin-top: 2.0833vw;">
                    <div class=" text-white" style="margin-left: 2.0833vw;">Region</div>
                    <SelectInput :option_list="['Please select']" style="margin-left:0.46875vw;"/>
                    <div class=" text-white" style="margin-left: 2.0833vw;">Period</div>
                    <PickerInput ph_value="Please select time" style="margin-left:0.46875vw;"/>
                    <BarGreenBtn text="Print" ml_val="2.6041vw" w_val="7.9166vw" h_val="2.65625vw"/>
                    <ExpandSearchInput ml_val="0.6041vw" h_val="2vw" w_val="8.41666vw" place_holder="Please enter here"/>
                </div>
    ...
    methods: {
        ...
        formatTbData() {
            for (let index = 0; index < 50; index++) {
                var obj_var = {}
                obj_var['No'] = this.addZeroToInt(index + 1)
                obj_var['Type'] = "AI Box"
                obj_var['Device ID'] = 'AI001'
                obj_var['Region'] = `A-${index + 1}-Region`
                obj_var['Status'] = "Online"
                obj_var['Time'] = "2021-05-11 12:11:11"
                obj_var['State'] = "Processed"
                obj_var['Processing Time(Sec)'] = "455"
        ...
        renderPieChart() {
            ...
            var seriesData = [
                { "name": "New", "value": 30, itemStyle: {color: '#ffcc66'} },
                { "name": "Old", "value": 10, itemStyle: {color: '#64c4f7'} },
                { "name": "Passed", "value": 15, itemStyle: {color: '#f67467'} },
            ]

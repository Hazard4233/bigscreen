            ...
            <router-link to="/page7/part1">
                <div class="flex flex-row items-center cursor-pointer">
                    ...
                    <div class="text-r205g234b255 px-2 ml-1 flex flex-row items-center justify-center" 
                        style="height: 1.63934vw; background-image: linear-gradient(to bottom, rgb(0, 0, 0), rgb(187, 124, 31)); font-size: 0.867888vw;">Role Manage</div>
                </div>
            </router-link>
                ...
                <table class="w-full">
                    <thead>
                        <tr>
                            ...
                            <td class="text-white text-center" style="padding:0.83333vw;">Role Type</td>
                            <td class="text-white text-center" style="padding:0.83333vw;">Role Description</td>
                            <td class="text-white text-center" style="padding:0.83333vw;">Account</td>
                    ...
                    <tbody>
                        <tr v-for="(item, index) in tb_data" :key="index + 'id'" class="text-center" :class="{'hidden': index > num_per_page - 1}">
                            ...
                            <td class=" text-r205g234b255" style="padding:1.25vw;">{{item.description}}</td>
...
export default {
    ...
    mounted: function() {
        ...
        for (let index = 0; index < 50; index++) {
            ...
            obj_var.name = "Super Admin"
            obj_var.description = "All management rights of the system"
